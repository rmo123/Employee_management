    ...
    <div class="container">
        ...
        <div class="table-responsive">
                        ...
                        <tr>
                            <td >
                                <div class="show" style="display:none;">
                                    <label for="show">
                                        <input type="checkbox" />&nbsp;id- <?php echo $row["e_id"];?>
                                    </label>
                                </div>
                            </td>
                            ...
                            <td class="btns">
                                <a href="model.php?update=1&id=<?php echo $row["e_id"];?>" >
            ...
            <div class="show m-3 col-6"  style="text-align:center;display:none;">
                <a href="">
                    <button type="button" name="" id="" class="btn btn-danger btn-lg btn-block">Delete Multiple Rows</button>
                </a>
            </div>
